...
enum {
  RHR = 0, // receive holding register (for input bytes)
  THR = 0, // transmit holding register (for output bytes)
  ...
  LSR_TX_IDLE = (1 << 5)     // THR can accept another character to send
};
